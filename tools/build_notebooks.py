...
write("01_load_data.ipynb", [
    ...
    md("## Recover the gene lost to NA parsing",
         "",
    ...
    code("bad = pd.isna(adata.var_names)",
    ...
    code("for col in ['sample', 'sample_folder', 'sex', 'treatment',",
    ...
    code("adata.obs['sample'].value_counts().sort_index()"),
